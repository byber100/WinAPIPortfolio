...
void PlayUI::UpdateSpeed()
{
	...
	else if (16.0f <= Speed && 17.0f > Speed)
	{
		Speed_ = 11;
		SpeedTile1_->SetIndex(10);
		SpeedTile2_->SetIndex(10);
	...
	else if (15.0f <= Speed && 16.0f > Speed)
	{
		Speed_ = 10;
		SpeedTile1_->SetIndex(10);
		SpeedTile2_->SetIndex(10);
	...
	else if (14.0f <= Speed && 15.0f > Speed)
	{
		Speed_ = 9;
		SpeedTile1_->SetIndex(10);
		SpeedTile2_->SetIndex(10);
	...
	else if (13.0f <= Speed && 14.0f > Speed)
	{
		Speed_ = 8;
		SpeedTile1_->SetIndex(10);
		SpeedTile2_->SetIndex(10);
